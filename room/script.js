...
function init() {
    ...
    // room material
    const wall = new THREE.MeshPhongMaterial({ color: 0x640F1E });
    ...
    //const cielingMat = new THREE.MeshPhongMaterial({ color: 0x420812});
    ...
    const imgSource = new THREE.TextureLoader().load("./test.jpg");
    ...
    const ground = new THREE.MeshPhongMaterial({ color: 0x000000, flatShading: true });
